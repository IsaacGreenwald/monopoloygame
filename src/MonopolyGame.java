...
/**
 * Represents the core Monopoly game logic and handles player setup.
 */
public class MonopolyGame {
    ...
    /**
     * Runs the Monopoly game, including player setup and the game loop.
     *
     * @throws SQLException
     */
    ...
    private Player loadSavedGame(Scanner scanner) throws SQLException {
        ...
        if (loadedPlayer != null) {
            ...
            System.out.println("Game loaded successfully for " + loadedPlayer.getName() + ", Money: " + loadedPlayer.getMoney());
    ...
    public void continueGameLoop(Player player, Board board) {
        ...
        while (!gameOver) {
            ...
            case 1:
                ...
                int newPosition = player.move(board, roll1, roll2);
    ...
    public void run(Scanner scanner) {
        ...
        computerPlayers = getComputerPlayers(numPlayers);
            ...
            if (turn == 0) { // human goes first
                ...
                switch (choice) {
                    case 1:
                        int roll1 = rollDice();
                        int roll2 = rollDice();
                        int roll = player.move(board, roll1, roll2);
                ...
                for (int i = 0; i < numPlayers; i++) {
                    ...
                    int computerRoll = computerPlayers.get(i).move(board, computerRoll1, computerRoll2);
    ...
    private void mortgageOrUnmortgageProperty(Player player) {
        ...
        // Show on the terminal a list of the player's properties and their mortgage status
    ...
    protected ArrayList<ComputerPlayer> getComputerPlayers(int numPlayers) {
        ...
        for (int i = 0; i < numPlayers; i++) {
            ...
            switch (answer) {
                case DEFAULT:
                    ComputerPlayer computerPlayer = new ComputerPlayer(String.valueOf(i), new DefaultStrategy(), null);
                    MonopolyPiece monopolyPiece = getChosenPiece(in);
                    computerPlayer.setPiece(monopolyPiece);
                    computerPlayers.add(computerPlayer);
            }
            answer = 0; // reset strategy for the next computer player
        }
